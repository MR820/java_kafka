...
public class Lesson01 {
    ...
    public void consumer(){
        ...
        p.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG,"latest");//第一次启动，米有offset
        /**
         ...
         *         </ul>";
         */
        p.setProperty(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG,"false");//自动提交是异步提交，丢数据&&重复数据
...
//                    pRecords.stream().sorted()
                    ...
                    while(piter.hasNext()){
                        ...
                        map.put(sp,om);
//
                        consumer.commitSync(map);//这个是最安全的，每条记录级的更新，第1点`
                        //单线程，多线程，都可以
                         */
                    }
                    ...
                    consumer.commitSync( map );//这个是第2点，分区粒度提交offset
